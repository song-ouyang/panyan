...
const privacyChoicesPage: PublicPage = {
  ...
  content: `
    ...
    <section>
      <h2>内容与社交关系</h2>
      <p>你可以管理自己发布的动态、图片、视频和线路内容，并按产品提供的选项调整公开、仅岩友可见或私密范围。你也可以在“我的岩友”中解除岩友关系。</p>
    </section>
    <section>
      <h2>注销账号并删除数据</h2>
...
const termsPage: PublicPage = {
  ...
  content: `
    ...
    <section><h2>5. 服务管理</h2><p>为维护社区安全和服务稳定，我们可对违规内容或账号采取提醒、限制功能、删除内容或终止服务等措施。排行榜用于社区激励，不构成官方竞技成绩。</p></section>
