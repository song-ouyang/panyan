...
- 图文动态、评论直接通过并按公开/岩友/私密范围展示，支持点赞、仅本人可见的收藏
- 「我的」提供动态、评论、收藏、点赞四个入口，评论可查看和删除，收藏/点赞记录分页加载并支持取消；广场、朋友圈、详情同步互动状态，切换账号或失去可见权限时清理缓存
...
- Flutter 暖奶油主题、黑猫品牌角色、物理按压反馈、半透明悬浮胶囊导航、骨架屏、空态和 reduced-motion 适配
- 账户 Lv.0–10 等级、十枚成长徽章、累计完攀日与不同线路双条件进度、历史补授和一次性获得庆祝；Flutter 与小程序均提供徽章收藏及 C「木质小阶梯」音效开关，见 [账户等级与成长徽章](docs/account-levels.md)
...
应用允许游客浏览岩馆、广场公开动态和公开排行；朋友圈、个人资料、好友、打卡、投稿、发布、点赞、收藏与评论需要登录，登录后自动回到原操作。JWT 保存在 iOS Keychain / Android 加密存储中，401 会立即清理失效会话。
