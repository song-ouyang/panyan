...
if [[ "${ALLOW_PRODUCTION_SQUARE_POST_CLEANUP:-false}" != "true" ]]; then
  echo "请为本次清理命令传入 ALLOW_PRODUCTION_SQUARE_POST_CLEANUP=true。" >&2
  exit 1
fi
